  ...
  return (
    <div className="relative z-2 mb-16">
      ...
      >
        ...
        <div
          className={clsx(
            "faq-icon relative size-12 flex items-center justify-center rounded-full border-2 border-s2 shadow-400 trasition-all duration-500 group-hover:border-s4",
